...
var AdminService = /** @class */ (function () {
    function AdminService() {
        var _this = this;
        this.createAdmin = function (admin) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.findAdminByName = function (username) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, client.admin.findFirst({
                        where: {
                            username: username
                        }
                    })];
        ...
        this.isAdminExicted = function (username) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAdminByName(username)];
                    case 1:
                        admin = _a.sent();
                        return [2 /*return*/, admin !== null];
                }
            });
        }); };
