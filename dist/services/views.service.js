...
var ViewService = /** @class */ (function () {
    function ViewService() {
        ...
        this.updatingViewsWithStream = function (id, stream_url, views) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client.news.updateMany({
                            where: {
                                id: id,
                                streams: {
                                    every: {
        ...
        this.createIpWithStream = function (IP, newsId, stream_url) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client.iPs.create({
                            data: {
        ...
        this.findAllIP = function (newsId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
