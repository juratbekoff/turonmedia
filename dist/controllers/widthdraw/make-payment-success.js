...
exports.makePaymentSuccess = void 0;
var services_1 = require("../../services");
var client_1 = require("@prisma/client");
var widthdrawService = new services_1.WidthdrawService();
var balansService = new services_1.BalansService();
var makePaymentSuccess = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var widthdrawId, findWidthdraw, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, widthdrawService.makePaymentSuccess(widthdrawId)];
            case 2:
                _a.sent();
                return [2 /*return*/, res.status(200).json({
                        message: "Successfully payment!",
                        status: client_1.WidthdrawStatus.PAID
                    })];
            case 3:
                error_1 = _a.sent();
                next();
...
exports.makePaymentSuccess = makePaymentSuccess;
//# sourceMappingURL=make-payment-success.js.map