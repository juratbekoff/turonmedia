...
var premium = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newsId, stream_url, IP, checking, findIp, countingViews, updatedViews, findAdminBalans, addBalans, oldNews, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                findIp = _b.sent();
                if (!(findIp.length === 0)) return [3 /*break*/, 11];
            ...
            case 8: return [4 /*yield*/, (_b.sent()).map(function (obj) { return obj.amount; }).reduce(function (acc, curr) { return acc + curr; })];
            case 9:
                _b.sent();
            ...
            case 11: return [4 /*yield*/, newsService.findNewsById(newsId)];
            case 12:
                oldNews = _b.sent();
                return [2 /*return*/, res.status(200).send({
                        message: "ID: ".concat(newsId, ", stream_url: ").concat(stream_url, " news!"),
